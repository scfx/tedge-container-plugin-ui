...
import { Container, ContainerGroup, ContainerParent } from '../shared/container';
...
export class ContainerInfoComponent implements OnInit {
    ...
    async loadData() {
        [this.container,this.parentDevice] = await this.containerService.getContainer(this.serviceId);
